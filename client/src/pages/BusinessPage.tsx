...
import { businessPages } from "@shared/workPermits";
import SEOHead from "@/components/SEOHead";
import { Button } from "@/components/ui/button";
import { Link } from "wouter";
import { Clock, DollarSign, CheckCircle, HelpCircle, ArrowRight, Phone, Mail, Building } from "lucide-react";
...
export default function BusinessPage() {
  ...
  const pageData = businessPages.find(page => page.slug === slug);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">The business page you're looking for doesn't exist.</p>
          <Button asChild>
  ...
  return (
    <>
      <SEOHead
        ...
        canonicalUrl={`${window.location.origin}/business/${pageData.slug}`}
      />
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <motion.section 
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          data-testid="business-eligibility"
        >
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
        ...
        <motion.section 
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          data-testid="business-info-cards"
        >
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <Link href="/business">View All Business Services</Link>
                </Button>
              </div>
            </div>
          </div>
